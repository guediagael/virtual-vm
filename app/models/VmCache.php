...
namespace Wallet;
class VmCache extends \Phalcon\Mvc\Model implements \Wallet
{
    use \Wallet\TWallet;
    ...
    function getData()
    {
        $this->coins[Coin::ONE_RUB] = 0;
        $this->coins[Coin::TWO_RUB] = 0;
        $this->coins[Coin::FIVE_RUB] = 0;
        $this->coins[Coin::TEN_RUB] = 0;
    }
}
